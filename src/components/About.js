    ...
    return (
        ...
        >
            <h6 className="about__intro">
                 ...
                 Work hard with the full dedication to the organization and to the work assigned. I strongly believe in upgrading myself with technological changes in the field of interest.
